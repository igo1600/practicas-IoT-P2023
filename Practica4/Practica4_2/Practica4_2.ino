...
****************************************/
const char* UBIDOTS_TOKEN = "BBFF-dXs2nuqCSsUfIjT3ilVhaO82VKEf42"; // Put here your Ubidots TOKEN
const char* UBIDOTS_DEVICELABEL = "ubidots_device"; // Device label to use
